	function ycngtwMsg(){
        ...
        function billybobsMsg(){
                if (pistolHome) 
		   updateDisplay(arrayLocation[9].description + " " + arrayItem[3]);
                else {
        ...
        function airportMsg(){
                if (ticketHome)
		   updateDisplay(arrayLocation[1] + " " + arrayItem[0]);
                else {
        ...
        function robsMsg(){
                if (carkeysHome)
		   updateDisplay(arrayLocation[4] + " " + arrayItem[1]);
                else {
        ...
        function streetMsg(){
                if (clothesHome)
		   updateDisplay(arrayLocation[6] + " " + arrayItem[2]);
                else {
